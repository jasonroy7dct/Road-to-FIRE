...
### 📸 Preview
<p align="center">
  <img src="assets/dashboard.png" width="80%" alt="Your FIRE Dashboard"/>
  <br>
  <em>Interactive FIRE Dashboard to track your progress</em>
</p>

<p align="center">
  <img src="assets/interceptor_amazon.png" width="45%" alt="Checkout Interceptor Amazon"/>
  <img src="assets/interceptor_alo.png" width="45%" alt="Checkout Interceptor Alo Yoga"/>
  <br>
  <em>Mindful Checkout Interceptors to pause impulse buying</em>
</p>

<p align="center">
  <img src="assets/popup.png" width="45%" alt="Popup Settings"/>
  <img src="assets/widget.png" width="45%" alt="Floating Widget"/>
  <br>
  <em>Popup controls and persistent floating widget</em>
</p>

### ✨ Key Features
- **Real-Time Price Conversion**: Instantly translates checkout totals into equivalent shares of index funds (e.g., VOO or 0050).
...
### ✨ 核心功能
- **即時價格換算**：將結帳總額即時轉化為等值的指數基金股數（如：美股 VOO，或台股 0050）。
